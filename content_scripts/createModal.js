const createModal = (word, meaning, example) => {
  ...
  const meaningLabelText = document.createTextNode(
    browser.i18n.getMessage('modalMeaningLabel'),
  );
  ...
  const exampleLabelText = document.createTextNode(
    browser.i18n.getMessage('modalExampleLabel'),
  );
  ...
  const closeButtonIcon = document.createElementNS(
  ...
  const closeButtonIconPath = document.createElementNS(
    'http://www.w3.org/2000/svg',
    'path',
  );
  closeButtonIconPath.setAttribute('fill', 'rgba(12, 12, 13, .8)');
  closeButtonIconPath.setAttribute(
    'd',
    'M5.293 6.707a1 1 0 1 1 1.414-1.414L12 10.586l5.293-5.293a1 1 0 1 1 1.414 1.414L13.414 12l5.293 5.293a1 1 0 0 1-1.414 1.414L12 13.414l-5.293 5.293a1 1 0 0 1-1.414-1.414L10.586 12 5.293 6.707z',
  );
